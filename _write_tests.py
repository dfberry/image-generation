"""Helper script to write the test file. Run once, then delete."""
import pathlib
...
pathlib.Path("tests/test_cli_validation.py").write_text(CONTENT, encoding="utf-8")
lines = CONTENT.count("\n")
print(f"OK: wrote {len(CONTENT)} chars, {lines} lines")
